...
def main() -> int:
    ...
    days = 140
    horizon = 7
    results = evaluate_forecast(make_synthetic_series(days=days, seed=seed), horizon=horizon)
    print(
        "Forecast evaluation on synthetic data "
        f"(seed={seed}, {days} days, holdout=last {horizon} days)"
    )
