...
```bash
PYTHONPATH=. python3 evals/run_router_eval.py --mode mock
PYTHONPATH=. python3 evals/run_router_eval.py --mode live
```
...
```bash
PYTHONPATH=. python3 evals/run_forecast_eval.py
```
